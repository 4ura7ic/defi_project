...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_USDC_WETH; // Pool 1
    ...
    constructor() {
        ...
        uniswapV2Pair_USDC_WETH = IUniswapV2Pair(uniswapV2Factory.getPair(address(USDC), address(WETH))); // Pool 1
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool, uint256 reserve_WETH_Pool, ) = uniswapV2Pair_USDC_WETH.getReserves(); // Pool 1
